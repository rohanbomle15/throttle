...
public class AddClubFragment extends Fragment {
	...
	private static final String TAB1 = "Club Details";
	private static final String TAB2 = "Description";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabHost.addTab(
				mTabHost.newTabSpec(TAB1).setIndicator(
						createTabView(ctx, TAB1)), AddClubDetailsScreen.class, arg1);

		Bundle arg2 = new Bundle();
		mTabHost.addTab(
				mTabHost.newTabSpec(TAB2).setIndicator(
						createTabView(ctx, TAB2)), AddClubDescriptionScreen.class, arg2);

		Bundle arg3 = new Bundle();
		mTabHost.addTab(
				mTabHost.newTabSpec(TAB3).setIndicator(
						createTabView(ctx, TAB3)), AddClubPhotosScreen.class, arg3);
